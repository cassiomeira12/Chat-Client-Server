package view.viewNotificacao.models;
...
public class CustomStage extends Stage {
	...
	public CustomStage(AnchorPane ap, StageStyle style) {
		...
		//Posicao centro superior da Aplicacao
		//x = Interface.PALCO.getX() + Interface.TELA_INICIAL.getWidth()/2 - ap.getPrefWidth()/2;
		//y = Interface.PALCO.getY();
